  ...
  <div v-else-if="room" class="mx-auto flex max-w-lg flex-col gap-4">
    ...
    <div class="rounded-xl border border-gray-100 bg-white p-6 shadow-sm">
      <RoomForm
        ...
        @submit="onSubmit"
      />
      <p v-if="!canEdit" class="mt-2 text-sm text-gray-500">Você tem acesso somente leitura a esta sala.</p>
    </div>

    <div v-if="canEdit && room.active" class="rounded-xl border border-red-100 bg-red-50 p-6">
      <h2 class="text-sm font-semibold text-red-800">Zona de perigo</h2>
      <p class="mt-1 text-sm text-red-700">Desativar a sala a torna indisponível para alocações.</p>
